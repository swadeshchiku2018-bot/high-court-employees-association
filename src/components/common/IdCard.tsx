...
export const IdCard: React.FC<IdCardProps> = ({ member, settings }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-6 w-full max-w-2xl mx-auto">
      ...
      <div
        className="flex justify-center w-full overflow-hidden sm:overflow-visible printable-id-card"
        style={{ height: 'calc(378px * min(0.55, calc((100vw - 32px) / 600)))' }}
      >
        ...
        <div
          ...
          style={{ transform: 'scale(min(0.55, calc((100vw - 32px) / 600)))' }}
        >
          <div
            ref={printRef}
                  ...
                  <div className="flex items-center justify-between text-[11px] text-slate-800 font-medium mt-3">
                    ...
                    <div className="flex items-center gap-2 flex-1 px-4 border-r border-slate-300">
                      ...
                      <div className="leading-tight">
                        ...
                        {settings?.email || "OHCEA.cuttack@gmail.com"}
                      </div>
                    </div>
