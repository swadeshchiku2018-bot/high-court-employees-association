...
export const ReceiptModal: React.FC<ReceiptModalProps> = ({ contribution, settings, onClose }) => {
  ...
  useEffect(() => {
    if (contribution) {
      const verifyText = `OHCEA RECEIPT NO: ${contribution.receiptNo} | MEMBER: ${contribution.memberName} (${contribution.membershipNumber}) | AMOUNT: ₹${contribution.amount} | DATE: ${contribution.date}`;
          ...
          <div className="flex items-end justify-between pt-6 border-t border-slate-200">
            <div className="flex items-center gap-3">
              ...
              <div className="text-[11px] text-slate-500">
                ...
                <p>Scan to verify authenticity on OHCEA portal.</p>
              </div>
            </div>
