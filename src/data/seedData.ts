...
export const initialSettings: AssociationSettings = {
  ...
  aboutText: "The High Court Employees' Association (OHCEA) represents over 1,200 dedicated judicial administrative officers, section officers, court masters, stenographers, translators, and staff members across all wings of the High Court. Established in 1978, OHCEA works indefatigably to safeguard employment rights, provide emergency medical & educational welfare grants, and promote professional camaraderie.",
...
export const initialOfficeBearers: OfficeBearer[] = [
  ...
  },
  {
    ...
    email: "vicepresident@OHCEA.gov.in",
    term: "2024 - 2026"
  },
  {
    id: "ob-3",
  ...
  },
  {
    ...
    email: "jointsecretary@OHCEA.gov.in",
    term: "2024 - 2026"
  },
  {
    id: "ob-5",
    ...
    shortBio: "Chartered finance expert managing OHCEA Welfare Corpus Fund, audit reports, online payment reconciliations, and tax compliance.",
    photo: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&w=400&q=80",
    priority: 5,
    phone: "+91 94370 56789",
    email: "treasurer@OHCEA.gov.in",
    term: "2024 - 2026"
  },
  {
    id: "ob-6",
    ...
    email: "priyanka.jena@OHCEA.gov.in",
    term: "2024 - 2026"
  }
];
...
export function generateSeedMembers(): Member[] {
  return namesList.map((name, index) => {
    ...
    let email = `member${index + 1}@OHCEA.gov.in`;
    if (isPresident) email = 'president@OHCEA.gov.in';
    if (isSecretary) email = 'secretary@OHCEA.gov.in';
    if (isTreasurer) email = 'treasurer@OHCEA.gov.in';
    if (index === 7) email = 'member@OHCEA.gov.in'; // Test member
    if (isPending) email = `pending${index - 47}@OHCEA.gov.in`;

    return {
      id: `mem-${index + 1}`,
      email,
      role,
      membershipId: `OHCEA-2026-${num}`,
  ...
  members.filter(m => m.status === 'ACTIVE').slice(0, 25).forEach((m) => {
    ...
    months.forEach((mStr) => {
      ...
      contributions.push({
        ...
        remarks: 'Monthly Subscription for OHCEA Welfare Fund'
      });
      count++;
    });
  });
  ...
  return [
    {
      ...
      membershipNumber: "OHCEA-2026-0008",
      type: "MEDICAL",
      amountRequested: 75000,
      amountApproved: 75000,
      reason: "Emergency Cardiac Surgery Support",
      description: "Underwent emergency angioplasty at Apollo Hospitals. Requesting medical relief grant as per OHCEA Clause 4(b).",
      status: "DISBURSED",
      bankDetails: {
    ...
    },
    {
      ...
      membershipNumber: "OHCEA-2026-0010",
      type: "EDUCATION",
    ...
    },
    {
      ...
      membershipNumber: "OHCEA-2026-0015",
      type: "EMERGENCY",
...
export function generateSeedFundTransactions(): FundTransaction[] {
  return [
    ...
    },
    {
      ...
      description: "Medical Welfare Disbursement to Sri Sanjib Kumar Rout (OHCEA-2026-0008)",
      amount: 75000,
...
export const initialNotices: Notice[] = [
  ...
  },
  {
    ...
    category: "GENERAL",
    description: "Members can download their verified digital ID cards or request physical cards at the OHCEA Office.",
...
export const initialEvents: EventItem[] = [
  ...
  {
    id: "evt-3",
    title: "OHCEA Foundation Day & Cultural Evening Celebration",
    date: "2026-09-18",
...
export const initialAuditLogs: AuditLog[] = [
  {
    ...
    details: "Approved membership application for Sri Sanjib Kumar Rout (OHCEA-2026-0008)",
  ...
  },
  {
    ...
    details: "Disbursed ₹75,000 medical assistance grant to member OHCEA-2026-0008",
