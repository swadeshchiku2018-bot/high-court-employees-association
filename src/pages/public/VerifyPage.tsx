      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xl space-y-4">
        <form onSubmit={handleSearch} className="flex gap-2">
          <div className="relative flex-1">
            ...
            <input
              type="text"
              placeholder="Enter Membership ID e.g. OHCEA-2026-0008"
              value={memberIdInput}
        ...
        <div className="text-[11px] text-slate-500 flex items-center gap-1.5 justify-center">
          ...
          <span>You can also scan the QR code printed on the back of any physical or digital OHCEA ID card.</span>
        </div>
      </div>
